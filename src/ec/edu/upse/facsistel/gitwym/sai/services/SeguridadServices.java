...
import ec.edu.upse.facsistel.gitwym.sai.repositories.SeguridadRepository;
...
public class SeguridadServices {
	...
	@Autowired private SeguridadRepository repository;
	
	@PostMapping("/saveOrUpdate")
	public Seguridad saveOrUpdate(@RequestBody Seguridad c) {
	...
	public List<Seguridad> getAll() {
		return (List<Seguridad>) repository.findAll();
	}
}
