...
import ec.edu.upse.facsistel.gitwym.sai.repositories.AccesibilidadRepository;
...
public class AccesibilidadServices {
	...
	@Autowired private AccesibilidadRepository repository;
	
	@PostMapping("/saveOrUpdate")
	public Accesibilidad saveOrUpdate(@RequestBody Accesibilidad c) {
	...
	@GetMapping("/getAll")
	public List<Accesibilidad> getAll() {
		return (List<Accesibilidad>) repository.findAll();
	}
}
