...
import ec.edu.upse.facsistel.gitwym.sai.repositories.RecorridoRepository;
...
public class RecorridoServices {
	...
	@Autowired private RecorridoRepository repository;
	
	@PostMapping("/saveOrUpdate")
	public Recorrido saveOrUpdate(@RequestBody Recorrido c) {
	...
	public List<Recorrido> getAll() {
		return (List<Recorrido>) repository.findAll();
	}
}
